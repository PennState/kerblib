...
adminLock : $(adminLock_src)
	$(CXX) -o bin/adminLock $< $(CC_ARGS) -L./lib -lkrb_security -L$(COMMON_LIB_ROOT)/lib/ -lait_utilities -lait_communications -lboost_regex

adminUnlock : $(adminUnlock_src)
	$(CXX) -g -o bin/adminUnlock $< $(CC_ARGS) -L./lib -lkrb_security -L$(COMMON_LIB_ROOT)/lib/ -lait_utilities -lait_communications -lboost_regex

$(warning $(kadminRest_src))
kadminRest : $(kadminRest_src)
	$(CXX) -g -o bin/kadminRest $? $(CC_ARGS) -L./lib -lkrb_security -L$(COMMON_LIB_ROOT)/lib/ -lait_utilities -lait_communications -lboost_regex
